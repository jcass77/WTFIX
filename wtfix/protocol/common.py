...
class MsgType:
    ...
    def get_name(cls, type_):
        """
        Given a binary string, retrieves the type name from the FIX specification.
        :param type_: a type name
    ...
    def get_type(cls, type_name):
        """
        Given a type name, retrieve the type binary string from the FIX specification.
...
class Tag:
    ...
    def get_name(cls, tag):
        """
        Given a tag number, retrieves the tag name from the FIX specification.
        :param tag: a tag number
    ...
    def get_tag(cls, tag_name):
        """
        Given a tag name, retrieve the tag number from the FIX specification.
        :param tag_name: a tag name
