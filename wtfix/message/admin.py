...
class Heartbeat(GenericMessage):
    ...
    def __init__(self, test_request_id):
        super().__init__((Tag.MsgType, MsgType.Heartbeat), (Tag.TestReqID, test_request_id))


class TestRequest(GenericMessage):
    """Generic TestRequest message"""
    def __init__(self, test_request_id):
        super().__init__((Tag.MsgType, MsgType.TestRequest), (Tag.TestReqID, test_request_id))
