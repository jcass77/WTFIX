...
class TestSettings:
    ...
    def test_default_connection_name_raises_exception_if_multiple_sessions_defined(self):
        ...
        try:
            settings.default_connection_name
    ...
    def test_default_session_returns_default_if_safe(self):
        assert isinstance(settings.default_connection, SessionSettings)
    ...
    def test_get_group_templates_returns_templates_for_only_those_identifiers_specified(
        ...
        orig_templates = settings.CONNECTIONS["default"]["GROUP_TEMPLATES"]
        new_templates = {
            **orig_templates,
            **{1: [11, 12, 13], 2: [21, 22, 23], 3: [31, 32, 33]},
        }

        settings.CONNECTIONS["default"]["GROUP_TEMPLATES"] = new_templates
        ...
        settings.CONNECTIONS["default"]["GROUP_TEMPLATES"] = orig_templates
